...
/**
 * Title: 404
 * Slug:  myblocktheme/404
 * Categories: myblocktheme-wp-pattern-cat
 */
?>
...
<div class="wp-block-group alignwide" style="margin-top:5px">
    ...
    <!-- wp:search {"label":"<?php echo esc_html_x('Search', 'label',
        'myblocktheme'); ?>","placeholder":"<?php echo esc_attr_x('Search...', 'placeholder for search field',
        'myblocktheme'); ?>","showLabel":false,"width":100,"widthUnit":"%","buttonText":"<?php esc_attr_e('Search',
        'myblocktheme'); ?>","buttonUseIcon":true,"align":"center"} /-->
</div>
<!-- /wp:group -->
